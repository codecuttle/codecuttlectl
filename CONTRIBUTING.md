...
- Runtime baseline: `make test-runtime-characterization` builds isolated CLI and
  plugin binaries and runs text, multi-tool correction, and step-limit scenarios
